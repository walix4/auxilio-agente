      ...
      <div className="container-wide relative">
        ...
        <div className="mt-20 lg:mt-28">
          ...
          >
            ...
            <h3 className="mt-5 font-display text-[28px] font-medium tracking-[-0.025em] text-white text-balance lg:text-[34px]">
              See every responder within 5km — in real time.
            </h3>
            <p className="mt-4 text-[15px] leading-[1.55] text-haze-300">
              Auxilio's radar sweeps the area every 3 seconds. Dispatch, supervisors,
              squad mates, family contacts, and ambient cohort all surface on a
              single live canvas keyed to the officer's bearing.
            </p>
          </motion.div>
